...
var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "lui-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "lui-upload-list-item", key: item.uid },
